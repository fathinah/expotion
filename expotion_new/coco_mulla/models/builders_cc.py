...
import omegaconf
import torch
from ..audiocraft import modules

from ..audiocraft.models.encodec import CompressionModel, EncodecModel, FlattenedCompressionModel  # noqa
from .lm_cc import LMModel
