...
class CPTransformer(nn.Module):
    ...
    #     # print(o.shape) # B,T,768
        
    #     cond_mask = torch.ones([B, T, 12]).to(o.device) ## drum 
    #     mask_embedding = self.masked_embedding[None, :, :T].repeat(B, 1, 1, 1)
    #     print("cond_mask", cond_mask.shape)
    #     print("mask-embed",mask_embedding.shape)
    ...
    #         cond = face
    #         mask_embedding_per_layer = torch.ones([B, T, 12]).to(o.device)
